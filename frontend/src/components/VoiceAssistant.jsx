    ...
    <div className="bg-slate-50 border border-slate-200/80 rounded-2xl p-6 md:p-8 text-center max-w-md mx-auto shadow-xs font-sans">
      ...
      <div className="relative w-28 h-28 mx-auto mb-6 flex items-center justify-center">
        ...
        <button
          ...
          className={`relative z-10 w-20 h-20 rounded-full cursor-pointer flex items-center justify-center text-white shadow-sm transition-all duration-300 hover:scale-105 active:scale-95 ${ui.class}`}
        >
          {state === 'speaking' ? (
